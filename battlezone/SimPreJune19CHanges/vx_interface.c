  ...
  if (game == BATTLEZONE)
    {
      ...
      /*
      printf ("switches [0].leftfwd: %i\n", switches [0].leftfwd);
      printf ("switches [0].leftrev: %i\n", switches [0].leftrev);
      printf ("switches [0].rightfwd: %i\n", switches [0].rightfwd);
      printf ("switches [0].rightrev: %i\n", switches [0].rightrev);
      printf ("switches [0].fire: %i\n", switches [0].fire);
      */
  ...
  if (game == LUNAR_LANDER)
  {
      if (z == 0)
      {
        if (FromY == ToY)
        {
          if (ToY>370)
          {
          printf("PlatformLine: (x %i,y %i) to (x %i,y %i)\n", FromX, FromY, ToX, ToY);
          z = 127/8;
...
//  printf("R: %02x, G: %02x,B: %02x, intensity: %02x\n", (Colour15&0b0001100)>>2, (Colour15&0b0000010)>>1, (Colour15&0b0000001), z);
//  if (z>15) printf("WARNING!!!\n");
}
