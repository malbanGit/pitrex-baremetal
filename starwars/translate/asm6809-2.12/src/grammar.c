...
{
  "$end", "error", "$undefined", "WS", "ID", "INTERP", "FLOAT", "INTEGER",
  "BACKREF", "FWDREF", "REGISTER", "TEXT", "SHL", "SHR", "LE", "GE", "EQ",
  "NE", "LOR", "LAND", "DELIM", "DEC2", "INC2", "'?'", "':'", "'|'", "'^'",
  "'&'", "'<'", "'>'", "'+'", "'-'", "'*'", "'/'", "'%'", "UMINUS", "'!'",
  "'~'", "'('", "')'", "'\\n'", "','", "'['", "']'", "'#'", "$accept",
  "program", "line", "label", "id", "idlist", "idpart", "arglist", "arg",
  "reg", "expr", "string", "strlist", "strpart", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,    63,    58,   124,    94,    38,    60,    62,
      43,    45,    42,    47,    37,   278,    33,   126,    40,    41,
      10,    44,    91,    93,    35
};
# endif
...
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep)
{
  ...
  switch (yytype)
    {
          case 4: /* ID  */
#line 66 "grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).as_string)); }
#line 1166 "grammar.c" /* yacc.c:1257  */
        break;

    case 5: /* INTERP  */
#line 66 "grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).as_string)); }
#line 1172 "grammar.c" /* yacc.c:1257  */
        break;

    case 11: /* TEXT  */
#line 66 "grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).as_string)); }
#line 1178 "grammar.c" /* yacc.c:1257  */
        break;
...
#line 188 "grammar.y" /* yacc.c:1906  */
