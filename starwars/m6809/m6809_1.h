...
extern int (**m6809_1_readHandler)(int);
#define M6809_1_RDMEM(A) ((unsigned)(m6809_1_readHandler[A](A)) )
...
extern void (**m6809_1_writeHandler)(int,int);
#define M6809_1_WRMEM(A,V) ((void)(m6809_1_writeHandler[A](A,V)) )
...
#define M6809_1_RDOP_ARG(A) (RAM[A])
