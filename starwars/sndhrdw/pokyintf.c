...
//#define TARGET_EMULATION_RATE 10000 //44100//44100	/* will be adapted to be a multiple of buffer_len */
...
//	emulation_rate = buffer_len * driver[gamenum].fps;
	...
	if (usePSGSamples)
	{
	    buffer_len = TARGET_EMULATION_RATE / 50;
	}
	else
	{
	    buffer_len = 100 / 50;
...
// enabling this will ou9tput awfull digitized sound!
	  if (usePSGSamples)
	  {
	    v_addIRQMultiSample(buffer, buffer_len, PLAY_ONCE);
	  }
