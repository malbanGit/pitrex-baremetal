...
else
{
    ...
    if (opadd == 0x6803) printf("loadHighScore(); \n");
...
bcheckme((opadd+temp+2)&0x7FFF);
        ...
        case 0x8D: //sta6502
            ...
            {
                printf("   if (dvg_draw_screen()) break;\n");
            }
            else
            {
if (temp == 0x3200)
  printf("    WriteMemory3200(A);\n");
else
...
*/
    do_rom ("035145-02.ef2", 0x6800);
    do_rom ("035144-02.h2", 0x7000);
    do_rom ("035143-02.j2", 0x7800);
    do_rom ("035127-02.np3", 0x5000);
...
//   memset(oplen,0,sizeof(oplen));
    ...
    printf("static void loadHighScore();\n");
