...
void update_cabin_temp (void)
{
	...
	{
        printf ("(2) Game Over temperatur > , dist: %i (%i), temp: %i\n\r", dist, distOrg, myship.cabtemp);
		myship.cabtemp = 255;
		do_game_over ();
		return;
	}
...
void check_docking (int i)
{
	...
	{
		do_game_over();
        printf ("(1) Game Over docking to speedy\n\r");
		return;
	}
...
if (i==1)
{
  printf ("Sun updated to: %i,%i,%i\n\r", universe[1].location.x, universe[1].location.y, universe[1].location.z);
 ...
 */
const signed char scannerList[]=
{   (signed char) 16, // count of vectors
    (signed char) 0xB5, (signed char) 0xEA, (signed char) 0xB1, (signed char) 0xD5, // y0, x0, y1, x1
    (signed char) 0xB1, (signed char) 0xD5, (signed char) 0xA4, (signed char) 0xC5, // y0, x0, y1, x1
    (signed char) 0xA4, (signed char) 0xC5, (signed char) 0x99, (signed char) 0xD3, // y0, x0, y1, x1
    (signed char) 0x99, (signed char) 0xD3, (signed char) 0x94, (signed char) 0xEA, // y0, x0, y1, x1
    (signed char) 0x94, (signed char) 0xEA, (signed char) 0x91, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0x91, (signed char) 0x00, (signed char) 0x94, (signed char) 0x16, // y0, x0, y1, x1
    (signed char) 0x94, (signed char) 0x16, (signed char) 0x99, (signed char) 0x2D, // y0, x0, y1, x1
    (signed char) 0x99, (signed char) 0x2D, (signed char) 0xA4, (signed char) 0x3C, // y0, x0, y1, x1
    (signed char) 0xA4, (signed char) 0x3C, (signed char) 0xB1, (signed char) 0x2B, // y0, x0, y1, x1
    (signed char) 0xB1, (signed char) 0x2B, (signed char) 0xB5, (signed char) 0x16, // y0, x0, y1, x1
    (signed char) 0xB5, (signed char) 0x16, (signed char) 0xB7, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0xB7, (signed char) 0x00, (signed char) 0xB5, (signed char) 0xEA, // y0, x0, y1, x1
    (signed char) 0xB5, (signed char) 0xEA, (signed char) 0xA4, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0xA4, (signed char) 0x00, (signed char) 0xB5, (signed char) 0x16, // y0, x0, y1, x1
    (signed char) 0xB5, (signed char) 0x16, (signed char) 0xB7, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0xB7, (signed char) 0x00, (signed char) 0x91, (signed char) 0x00, // y0, x0, y1, x1
};



void displayScannerList(const signed char list[])
{
  ...
  while (count >0)  
  {
    ...
    int y1 = *list++;
    int x1 = *list++-2;
    v_directDraw32(x0<<7, y0<<7,x1<<7,y1<<7, 0x20);
    count --;
  }
}
void update_scanner (void)
{
	...
	displayScannerList(scannerList);
...
gfx_draw_circle_fixed (compass_centre_x, compass_centre_y, 20, 0x30, 8);
...
gfx_draw_circle_fixed (compass_x, compass_y, 5, 0x18, 6);
	}
	else
	{
//		gfx_draw_sprite (IMG_GREEN_DOT, compass_x, compass_y);
gfx_draw_circle_fixed (compass_x, compass_y, 5, 0x40, 6);
	}
...
const signed char missileList[]=
{   (signed char) 4, // count of vectors
    (signed char) 0x00, (signed char) 0x00, (signed char) 0x00, (signed char) 0x06, // y0, x0, y1, x1
    (signed char) 0x00, (signed char) 0x06, (signed char) 0x03, (signed char) 0x06, // y0, x0, y1, x1
    (signed char) 0x03, (signed char) 0x06, (signed char) 0x03, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0x03, (signed char) 0x00, (signed char) 0x00, (signed char) 0x00, // y0, x0, y1, x1
};
const signed char missileYellowList[]=
{   (signed char) 6, // count of vectors
    (signed char) 0x00, (signed char) 0x00, (signed char) 0x00, (signed char) 0x06, // y0, x0, y1, x1
    (signed char) 0x00, (signed char) 0x06, (signed char) 0x03, (signed char) 0x06, // y0, x0, y1, x1
    (signed char) 0x03, (signed char) 0x06, (signed char) 0x03, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0x03, (signed char) 0x00, (signed char) 0x00, (signed char) 0x00, // y0, x0, y1, x1
    (signed char) 0x01, (signed char) 0x01, (signed char) 0x01, (signed char) 0x05, // y0, x0, y1, x1
    (signed char) 0x02, (signed char) 0x05, (signed char) 0x02, (signed char) 0x01, // y0, x0, y1, x1
};

void display_missiles (void)
{
    static int brightAdd=0;
...
//nomiss = 4;
	...
	{
      int xx = x + GFX_X_OFFSET;
      xx = xx / 2; // value from -128 - +128

      if (missile_target < 0) // yellow
      {
        v_displayAbsolutList_8o(xx+4,y,missileYellowList, 0x30);
      }
      else // red
      {
        v_displayAbsolutList_8o(xx+4,y,missileYellowList, 0x60+brightAdd*2);
      }
      x += 16;
      nomiss--;
	}
	...
	for (; nomiss > 0; nomiss--)
	{
      int xx = x + GFX_X_OFFSET;
      xx = xx / 2; // value from -128 - +128
      v_displayAbsolutList_8o(xx+4,y,missileList, 0x30);
  	  x += 16;
	}
}

void printString_s( int x, int y , char *strbuf)
{
  ...
  v_printString(x, y, strbuf, 5, 0x2f);
}
...
void update_console (void)
{
    ...
    if (!((current_screen == SCR_FRONT_VIEW) || (current_screen == SCR_LEFT_VIEW) || (current_screen == SCR_RIGHT_VIEW) || (current_screen == SCR_REAR_VIEW) ))
        return;
...
//	gfx_draw_scanner();
	...
	if (ship_count[SHIP_CORIOLIS] || ship_count[SHIP_DODEC])
      printString_s( 387, 490, "S");    
	//	gfx_draw_sprite (IMG_BIG_S, 387, 490);

	if (ecm_active)
      printString_s( 115, 490, "E");    
