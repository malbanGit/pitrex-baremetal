...
int save_commander_file (char *path)
{
	...
	if (fp == NULL)
    {
        printf("(1) Elite could not be saved: %s\n\r", path);
        return 1;
    }
    ...
    {
        printf("(2) Elite could not be saved: %s\n\r", path);
        return 1;
    }
		
	if (fclose (fp) == EOF)
    {
        printf("(3) Elite could not be saved: %s\n\r", path);
        return 1;
    }
...
int load_commander_file (char *path)
{
	...
	if (fp == NULL)
    {
        printf("(1) Elite could not be loaded: %s\n\r", path);
        return 1;
    }

	if (fread (block, 256, 1, fp) != 1)
    {
        printf("(2) Elite could not be loaded: %s\n\r", path);
        return 1;
    }
    ...
    {
        printf("(2a) Elite could not be loaded: %s\n\r", path);
        return 1;
    }
	...
	if (fclose (fp) == EOF)
    {
        printf("(3) Elite could not be loaded: %s\n\r", path);
        return 1;
    }
    printf("Elite load successfull: %s\n\r", path);
