========================================================================
    KONSOLENANWENDUNG: musashiMake-Projektübersicht
========================================================================

Diese musashiMake-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die musashiMake-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen musashiMake.pch sowie eine vorkompilierte 
