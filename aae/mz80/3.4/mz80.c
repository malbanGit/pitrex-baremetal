...
static const char *pbPC;			/* Program counter normalized */
static const char *pbSP;			/* Stack pointer normalized */
...
static const char *pbAddAdcTable;	/* Pointer to add/adc flag table */
static const char *pbSubSbcTable;	/* Pointer to sub/sbc flag table */
			...
			sdwCyclesRemaining -= 15;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							bTemp = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = bTemp;
						}
						psMemWrite = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemWrite->lowAddr) && (dwTemp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr)) = cpu.z80BC;
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr) + 1) = cpu.z80BC >> 8;
						}
						psMemWrite = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemRead->lowAddr) && (dwTemp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80BC = *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr));
							cpu.z80BC |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemWrite->lowAddr) && (dwTemp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr)) = cpu.z80DE;
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr) + 1) = cpu.z80DE >> 8;
						}
						psMemWrite = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemRead->lowAddr) && (dwTemp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80DE = *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr));
							cpu.z80DE |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemWrite->lowAddr) && (dwTemp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr)) = cpu.z80HL;
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr) + 1) = cpu.z80HL >> 8;
						}
						psMemWrite = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemWrite->lowAddr) && (dwTemp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr)) = cpu.z80sp;
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr) + 1) = cpu.z80sp >> 8;
						}
						psMemWrite = NULL;
						break;
					}
		...
		dwTemp |= ((UINT32) *pbPC++ << 8);
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemRead->lowAddr) && (dwTemp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80sp = *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr));
							cpu.z80sp |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 16;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80DE >= psMemWrite->lowAddr) && (cpu.z80DE <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80DE - psMemWrite->lowAddr)) = bTemp;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 20;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemWrite->lowAddr) && (dwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwAddr - psMemWrite->lowAddr)) = cpu.z80IX;
							*((const char *) psMemWrite->pUserArea + (dwAddr - psMemWrite->lowAddr) + 1) = cpu.z80IX >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 20;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemRead->lowAddr) && (dwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80IX = *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr));
							cpu.z80IX |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 23;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemRead->lowAddr) && (dwAddr <= psMemRead->highAddr))
					{
						...
						{
							bTemp = *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemWrite->lowAddr) && (dwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwAddr - psMemWrite->lowAddr)) = bTemp;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = *pbPC++;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80B = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80C = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80D = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80E = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80H = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80L = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80B;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80C;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80D;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80E;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80H;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80L;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemWrite->lowAddr) && (sdwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (sdwAddr - psMemWrite->lowAddr)) = cpu.z80A;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 19;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((sdwAddr >= psMemRead->lowAddr) && (sdwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80A = *((const char *) psMemRead->pUserArea + (sdwAddr - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 14;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80IX = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80IX |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 23;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							dwAddr = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							dwAddr |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80IX;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80IX >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 20;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemWrite->lowAddr) && (dwAddr <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwAddr - psMemWrite->lowAddr)) = cpu.z80IY;
							*((const char *) psMemWrite->pUserArea + (dwAddr - psMemWrite->lowAddr) + 1) = cpu.z80IY >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 20;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemRead->lowAddr) && (dwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80IY = *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr));
							cpu.z80IY |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 14;
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80IY = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80IY |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			sdwCyclesRemaining -= 23;
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80IY;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80IY >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x02:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80BC >= psMemWrite->lowAddr) && (cpu.z80BC <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80BC - psMemWrite->lowAddr)) = cpu.z80A;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x0a:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80BC >= psMemRead->lowAddr) && (cpu.z80BC <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80A = *((const char *) psMemRead->pUserArea + (cpu.z80BC - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x12:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80DE >= psMemWrite->lowAddr) && (cpu.z80DE <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80DE - psMemWrite->lowAddr)) = cpu.z80A;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x1a:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80DE >= psMemRead->lowAddr) && (cpu.z80DE <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80A = *((const char *) psMemRead->pUserArea + (cpu.z80DE - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x2a:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwAddr >= psMemRead->lowAddr) && (dwAddr <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80HL = *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr));
							cpu.z80HL |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (dwAddr - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x32:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemWrite->lowAddr) && (dwTemp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (dwTemp - psMemWrite->lowAddr)) = cpu.z80A;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x36:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = *pbPC++;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x3a:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((dwTemp >= psMemRead->lowAddr) && (dwTemp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80A = *((const char *) psMemRead->pUserArea + (dwTemp - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x46:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80B = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x4e:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80C = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x56:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80D = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x5e:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80E = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x66:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80H = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x6e:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80L = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0x70:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80B;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x71:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80C;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x72:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80D;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x73:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80E;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x74:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80H;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x75:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80L;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x77:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemWrite->lowAddr) && (cpu.z80HL <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80HL - psMemWrite->lowAddr)) = cpu.z80A;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0x7e:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80HL >= psMemRead->lowAddr) && (cpu.z80HL <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80A = *((const char *) psMemRead->pUserArea + (cpu.z80HL - psMemRead->lowAddr));
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0xc1:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80BC = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80BC |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0xc5:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80BC;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80BC >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0xd1:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80DE = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80DE |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0xd5:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80DE;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80DE >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0xe1:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80HL = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80HL |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0xe3:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80HL;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80HL >> 8;
						}
						psMemWrite = NULL;
						break;
					}
			...
			case 0xf1:
			{
				...
				while (psMemRead->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemRead->lowAddr) && (cpu.z80sp <= psMemRead->highAddr))
					{
						...
						{
							cpu.z80AF = *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr));
							cpu.z80AF |= (UINT32) ((UINT32) *((const char *) psMemRead->pUserArea + (cpu.z80sp - psMemRead->lowAddr + 1)) << 8);
						}
						psMemRead = NULL;
						break;
					}
			...
			case 0xf5:
			{
				...
				while (psMemWrite->lowAddr != 0xffffffff)
				{
					if ((cpu.z80sp >= psMemWrite->lowAddr) && (cpu.z80sp <= psMemWrite->highAddr))
					{
						...
						{
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr)) = cpu.z80AF;
							*((const char *) psMemWrite->pUserArea + (cpu.z80sp - psMemWrite->lowAddr) + 1) = cpu.z80AF >> 8;
						}
						psMemWrite = NULL;
						break;
					}
...
{
	UINT32 dwLoop;
	const char *pbTempPtr;
	const char *pbTempPtr2;
	UINT8 bNewAdd;
	UINT8 bNewSub;
	UINT8 bFlag;
	UINT8 bLow;
...
cycle count conditional branches wrong
